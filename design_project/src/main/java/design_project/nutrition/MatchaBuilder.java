...
public class MatchaBuilder extends NutritionBuilder {

   @Override
    public void ServingSize() {
        matcha.setServingSize("100ml ");
    }   
    
    @Override
    public void calories() {
        matcha.setcalories("20kcal ");
    }

    @Override
    public void protein() {
        matcha.setprotein("1g ");
    }

    @Override
    public void carbohydrate() {
       matcha.setcarbohydrate("3g ");
    }
