...
public class VanillaFrappuccinoBuilder extends NutritionBuilder {

   @Override
    public void ServingSize() {
        vanillaFrappuccino.setServingSize("200ml ");
    }
    ...
    public void calories() {
        vanillaFrappuccino.setcalories("560kcal ");
    }

    @Override
    public void protein() {
        vanillaFrappuccino.setprotein("9g ");
    }

    @Override
    public void carbohydrate() {
        vanillaFrappuccino.setcarbohydrate("51g ");
    }

    @Override
    public void fat() {
        vanillaFrappuccino.setfat("11g ");
    }

    @Override
    public void sodium() {
        vanillaFrappuccino.setsodium("340mg ");
    }

    @Override
    public void sugar() {
        vanillaFrappuccino.setsugar("48g ");
    }
