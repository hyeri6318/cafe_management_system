...
public class ChiffoncherryCakeBuilder extends NutritionBuilder {

   @Override
    public void ServingSize() {
        chiffoncherryCake.setServingSize("120g");
    }
    ...
    public void calories() {
        chiffoncherryCake.setcalories("220kcal ");
    }

    @Override
    public void protein() {
       chiffoncherryCake.setprotein("7g ");
    }

    @Override
    public void carbohydrate() {
        chiffoncherryCake.setcarbohydrate("20g ");
    }

    @Override
    public void fat() {
        chiffoncherryCake.setfat("4g ");
    }

    @Override
    public void sodium() {
        chiffoncherryCake.setsodium("190mg ");
    }

    @Override
    public void sugar() {
        chiffoncherryCake.setsugar("11g ");
    }
